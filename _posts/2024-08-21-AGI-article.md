...
Honestly, I think AI is great, it's going to be the most influential piece of technology since the internet and there is huge potential. The hype is going nowhere, with each release of a new model or implementation only fueling further excitement from consumers and investors alike.

The race toward AGI has begun, but the starting gun has barely sounded, and in reality it's more of a marathon than a sprint. There's still some huge technical and ethical hurdles to overcome before we cross the finish line, but I think we'll see many like Elon celebrating too early.

![Never celebrate too early](https://raw.githubusercontent.com/frank-64/ToBeFrank/master/assets/gif/never_celebrate_too_early_02.gif)
